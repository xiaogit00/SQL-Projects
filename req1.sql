...
ORDER BY a."createdAt"),
    vn_users AS (SELECT *
FROM "public"."Users" u
WHERE u."CountryCode" = 'VN')

SELECT DENSE_RANK() OVER (ORDER BY u."id") AS user_num,
u."id" user_id, u."firstName", u."lastName", date_part('year',age(u."birthDate")) age, u."email", c."name" city_name, a."JobId",j."title" job_title, a."createdAt" application_date, u."createdAt" signup_date,
